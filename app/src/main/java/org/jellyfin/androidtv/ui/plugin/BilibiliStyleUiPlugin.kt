...
class BilibiliStyleUiPlugin : UiPlugin {
    override val id = "bilibili"
    override val name = "Bilibili Style UI"
    ...
    override fun createViewModelFactory(): ViewModelProvider.Factory {
        return object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(modelClass: Class<T>): T {
                throw UnsupportedOperationException("BilibiliStyleUiPlugin uses pure Compose navigation")
            }
        }
    }
    ...
    override fun getComponentFactory(): UiPlugin.ComponentFactory = BilibiliComponentFactory()

    private class BilibiliComponentFactory : UiPlugin.ComponentFactory {
        @Composable
